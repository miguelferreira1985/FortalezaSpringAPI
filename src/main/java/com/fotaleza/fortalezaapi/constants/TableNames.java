...
public class TableNames {
    ...
    public static final String TABLE_PRODUCTS_SUPPLIERS = "product_suppliers";
    ...
    public static final String TABLE_PURCHASE_ORDERS = "purchaseOrders";
    public static final String TBALE_PURCHSE_ORDER_ITEMS = "purchaseOrderItems";
}